...
function Login() {
  ...
  return (
      ...
      <motion.div  initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}  className="flex flex-row flex-nowrap bg-white min-h-screen h-full relative">
        <div className="flex-[1] w-full h-full my-auto py-8 p-horizontal">
          <div className="relative w-full h-full flex flex-col justify-center">
            ...
            <img
              src={logo}
              alt="logo"
              className="w-[170px] h-[60px] mb-[40px]"
            />
